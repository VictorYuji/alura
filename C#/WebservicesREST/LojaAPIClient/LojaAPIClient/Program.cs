...
namespace LojaAPIClient
{
    class Program
    {
        ...
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://localhost:5230/api/carrinho/1/produto/6237/quantidade");
            request.Method = "PUT";
            //request.Accept = "application/json";
            request.ContentType = "application/xml";
            string xml = "<Produto xmlns:i='http://www.w3.org/2001/XMLSchema-instance' xmlns='http://schemas.datacontract.org/2004/07/Loja.Models' ><Id>6237</Id><Nome>Videogame 4</Nome><Preco>4000</Preco><Quantidade>100000</Quantidade></Produto>";
        ...
        static void TestaDELETEProdutos()
        {
